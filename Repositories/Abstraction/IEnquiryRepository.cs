...
namespace Louman.Repositories.Abstraction
{
    public interface IEnquiryRepository
    {
        ...
        Task<List<GetEnquiryDto>> GetAllAdminEnquiryById();
        Task<List<GetEnquiryDto>> GetAllAdminEnquiryByEnquiryTypeId(int enquiryTypeId);
        Task<EnquiryWithResponseDto> GetEnquiryWithResponse(int enquiryId);
        Task<List<GetEnquiryDto>> GetAllClientEnquiries(int clientUserId);
